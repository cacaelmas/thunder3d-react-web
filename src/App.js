                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                                    ...
                                                    <a class="dropdown-item" href="single-product.html">product
                                                        details</a>
                                    ...
                                    <div class="single_banner_slider">
                                        <div class="banner_text">
                                            <div class="banner_text_iner">
                                                <h5 style={{ color: 'white' }}>Winter Fasion</h5>
                                                <h1 style={{ color: 'white' }}>Fashion Collection 2019</h1>
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-4 col-sm-6">
                                <div class="single_feature_post_text">
                                    <img src="img/print_products/groot_no_logo.JPG" alt="#"/>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="single_feature_post_text">
                                    <img src="img/print_products/iron_man.jpg" alt="#"/>
                                    <div class="hover_text">
                                        <a href="single-product.html" class="btn_2">shop for male</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="single_feature_post_text">
                                    <img src="img/print_products/hulk.jpg" alt="#"/>
                                    <div class="hover_text">
                                        <a href="single-product.html" class="btn_2">shop for male</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="new_arrival_iner filter-container">
                                    <div class="single_arrivel_item weidth_1 mix shoes">
                                        <img src="img/print_products/hulk_behind.jpg" alt="#"/>
                                        <div class="hover_text">
                                            <p>Canvas</p>
                                    ...
                                    <div class="single_arrivel_item weidth_2 mix women">
                                        <img src="img/print_products/venom.jpg" alt="#"/>
                                        <div class="hover_text">
                                            <p>Canvas</p>
                                            <a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
                                            <div class="rate_icon">
                                    ...
                                    <div class="single_arrivel_item weidth_3 mix shoes women">
                                        <img src="img/print_products/trex_no_logo.jpg" alt="#"/>
                                        <div class="hover_text">
                                            <p>Canvas</p>
                                            <a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
                                            <div class="rate_icon">
                                    ...
                                    <div class="single_arrivel_item weidth_3 mix women men">
                                        <img src="img/print_products/groot_behind.jpg" alt="#"/>
                                        <div class="hover_text">
                                            <p>Canvas</p>
                                            <a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
                                            <div class="rate_icon">
                                    ...
                                    <div class="single_arrivel_item weidth_2 mix men women">
                                        <img src="img/print_products/iron_man_behind.jpg" alt="#"/>
                                        <div class="hover_text">
                                            <p>Canvas</p>
                                            <a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
                                            <div class="rate_icon">
                                    ...
                                    <div class="single_arrivel_item weidth_1 mix shoes men">
                                        <img src="img/print_products/dragon_stock.png" alt="#"/>
                                        <div class="hover_text">
                                            <p>Canvas</p>
                                            <a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
                                            <div class="rate_icon">
